...
declare function main(): {
	...
	createCanvas: (width: number, height: number, background?: string) => CanvasInfo;
	getCanvas: (canvasId: string) => CanvasInfo;
	listLayers: (canvasId: string) => CanvasLayer[];
	addImageLayer: (canvasId: string, imagePath: string, options: AddImageLayerOptions) => ImageLayer;
	duplicateLayer: (canvasId: string, layerId: string, x?: number, y?: number) => CanvasLayer;
	addTextLayer: (canvasId: string, text: string, x: number, y: number, options?: TextLayerOptions) => TextLayer;
	updateTextLayer: (canvasId: string, layerId: string, text: string, options?: TextLayerOptions) => TextLayer;
	moveLayer: (canvasId: string, layerId: string, x: number, y: number) => CanvasLayer;
	setLayerOpacity: (canvasId: string, layerId: string, opacity: number) => CanvasLayer;
	setLayerOrder: (canvasId: string, orderedLayerIds: string[]) => CanvasLayer[];
